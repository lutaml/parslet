...
describe Parslet::Optimizer, '.simplify_choices' do
  ...
  describe 'flattening nested alternatives' do
    it 'flattens Alternative(Alternative(a, b), c)' do
      inner = Parslet::Atoms::Alternative.new(str_a, str_b)
      outer = Parslet::Atoms::Alternative.new(inner, str_c)

      result = Parslet::Optimizer.simplify_choices(outer)
    ...
    it 'flattens Alternative(a, Alternative(b, c))' do
      inner = Parslet::Atoms::Alternative.new(str_b, str_c)
      outer = Parslet::Atoms::Alternative.new(str_a, inner)
    ...
    it 'flattens Alternative(Alternative(a, b), Alternative(c, d))' do
      inner1 = Parslet::Atoms::Alternative.new(str_a, str_b)
      inner2 = Parslet::Atoms::Alternative.new(str_c, Parslet::Atoms::Str.new('d'))
      outer = Parslet::Atoms::Alternative.new(inner1, inner2)
    ...
    it 'flattens deeply nested alternatives' do
      ...
      inner1 = Parslet::Atoms::Alternative.new(str_a, str_b)
      inner2 = Parslet::Atoms::Alternative.new(inner1, str_c)
      outer = Parslet::Atoms::Alternative.new(inner2, Parslet::Atoms::Str.new('d'))
  ...
  describe 'deduplicating alternatives' do
    it 'removes duplicate alternatives' do
      alt = Parslet::Atoms::Alternative.new(str_a, str_a, str_b)
      result = Parslet::Optimizer.simplify_choices(alt)
    ...
    it 'removes all duplicates keeping first occurrence' do
      alt = Parslet::Atoms::Alternative.new(str_a, str_b, str_a, str_c, str_b, str_a)
      result = Parslet::Optimizer.simplify_choices(alt)
    ...
    it 'unwraps when deduplication leaves single alternative' do
      alt = Parslet::Atoms::Alternative.new(str_a, str_a, str_a)
      result = Parslet::Optimizer.simplify_choices(alt)
  ...
  describe 'combined optimizations' do
    it 'flattens and deduplicates in one pass' do
      ...
      inner = Parslet::Atoms::Alternative.new(str_a, str_b)
      outer = Parslet::Atoms::Alternative.new(inner, str_a, str_b)
    ...
    it 'flattens, deduplicates, and unwraps' do
      ...
      inner = Parslet::Atoms::Alternative.new(str_a, str_a)
      outer = Parslet::Atoms::Alternative.new(inner, str_a)
  ...
  describe 'recursive optimization' do
    it 'optimizes alternatives nested in sequences' do
      ...
      alt = Parslet::Atoms::Alternative.new(str_a, str_a)
      seq = Parslet::Atoms::Sequence.new(alt, str_b)

      result = Parslet::Optimizer.simplify_choices(seq)
    ...
    it 'optimizes alternatives nested in repetitions' do
      ...
      alt = Parslet::Atoms::Alternative.new(str_a, str_a)
      rep = Parslet::Atoms::Repetition.new(alt, 0, nil, nil)

      result = Parslet::Optimizer.simplify_choices(rep)
    ...
    it 'optimizes alternatives nested in lookaheads' do
      ...
      alt = Parslet::Atoms::Alternative.new(str_a, str_a)
      la = Parslet::Atoms::Lookahead.new(alt, true)

      result = Parslet::Optimizer.simplify_choices(la)
    ...
    it 'optimizes alternatives nested in named atoms' do
      ...
      alt = Parslet::Atoms::Alternative.new(str_a, str_a)
      named = Parslet::Atoms::Named.new(alt, :test)

      result = Parslet::Optimizer.simplify_choices(named)
  ...
  describe 'preserving semantics' do
    it 'does not modify leaf atoms' do
      result = Parslet::Optimizer.simplify_choices(str_a)
      expect(result).to eq(str_a)
    end

    it 'preserves alternative order' do
      alt = Parslet::Atoms::Alternative.new(str_a, str_b, str_c)
      result = Parslet::Optimizer.simplify_choices(alt)
    ...
    it 'works with empty alternatives array (edge case)' do
      ...
      alt = Parslet::Atoms::Alternative.new
      result = Parslet::Optimizer.simplify_choices(alt)
  ...
  describe 'functional test with parser' do
    it 'correctly parses after optimization' do
      ...
      # Optimize it
      optimized = Parslet::Optimizer.simplify_choices(alt)

      # Should have 3 unique alternatives instead of 5
      expect(optimized).to be_a(Parslet::Atoms::Alternative)
    ...
    it 'correctly parses nested alternatives after optimization' do
      ...
      alt = (str_a | str_b) | (str_c | Parslet::Atoms::Str.new('d'))
