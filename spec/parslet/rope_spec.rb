...
describe Parslet::Rope do
  describe '#append' do
    ...
    it 'appends mixed strings and Slices' do
      rope = described_class.new
      rope.append('hello')
      rope.append(Parslet::Slice.new(5, ' '))
      rope.append('world')
      expect(rope.to_s).to eq('hello world')
    end
  ...
  describe '#to_s' do
    ...
    it 'joins Slice objects correctly' do
      rope = described_class.new
      rope.append(Parslet::Slice.new(0, 'first'))
      rope.append(Parslet::Slice.new(5, 'second'))
  ...
  describe '#empty?' do
    ...
    it 'returns false after appending Slice' do
      rope = described_class.new.append(Parslet::Slice.new(0, 'x'))
      expect(rope.empty?).to be false
    end
  end
