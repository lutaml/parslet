...
RSpec.describe Parslet::Comparative::BenchmarkRunner do
  # Use faster config for tests
  before do
    # Reduce benchmark time for tests
    allow_any_instance_of(Parslet::Comparative::MetricsCollector)
  ...
  describe '#initialize' do
    ...
    it 'initializes metrics collector' do
      runner = described_class.new
      expect(runner.metrics).to be_a(Parslet::Comparative::MetricsCollector)
    end
  end
end