...
# Phase 52 After: Measure performance after ivar caching in Sequence
...
puts "=" * 80
puts "Phase 52 After: Instance Variable Caching (Sequence only)"
puts "=" * 80
puts
...
puts
puts "Changes:"
puts "  - Sequence#try: Added parslets = @parslets cache"
puts
...
puts "=" * 80
puts
puts "Compare these results with baseline (profile_phase52_baseline.rb)"
puts
puts "Baseline results:"
puts "  Simple:      3.781k i/s"
puts "  Nested:      1.648k i/s"
puts "  Array Heavy:   959 i/s"
